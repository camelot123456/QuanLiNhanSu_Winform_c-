...
namespace INDIVIDUAL_PROJECT_CS414SC_2020S.repository
{
    class PRRepository
    {
        ...
        {
            string sql = @"
                    SELECT L.MALUONG, N.TENNV, L.LUONGCOBAN, L.HESOLUONG, L.LUONG1NGAY, L.SONGAYLAM, L.LUONGTHUONG, 
        ...
        {
            string sql = @"
                    SELECT L.MALUONG, N.TENNV, L.LUONG1GIO, L.SOGIOLAM, L.SONGAYLAM, L.LUONGTHUONG, 
